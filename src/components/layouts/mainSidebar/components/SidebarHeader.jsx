...
const SidebarHeader = () => {
    const {isFinding, setIsFinding} = useContext(SidebarContext);
    ...
    return (
        <div className={cx('sidebar-header')}>
            ...
            <div className={cx('search')}>
                ...
                >
                    <FontAwesomeIcon icon={faMagnifyingGlass} className={cx('search-button-icon')}>
                    </FontAwesomeIcon>
                    {!isFinding &&
                        <div className={cx('search-button-content')}>
                            Search
                        </div>
                    }
                </button>
